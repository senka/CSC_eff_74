...
DenominatorRequire_ExtraStation="( ( (CSCDxyTTSeg#1<5. || CSCDxyTTSeg#1<5*CSCDxyErrTTSeg#1) && CSCDxyTTSeg#1>0.) || ((CSCDxyTTSeg#2<5. || CSCDxyTTSeg#2<5*CSCDxyErrTTSeg#2) && CSCDxyTTSeg#2>0.) || ((CSCDxyTTSeg#3<5. || CSCDxyTTSeg#3<5*CSCDxyErrTTSeg#3) && CSCDxyTTSeg#3>0.) ) "#for segment efficiency, without closest to LCT requirement

DenominatorRequire_ExtraStation1="( ( (CSCDxyTTSeg#2<5. || CSCDxyTTSeg#2<5*CSCDxyErrTTSeg#2) && CSCDxyTTSeg#2>0.) || ((CSCDxyTTSeg#3<5. || CSCDxyTTSeg#3<5*CSCDxyErrTTSeg#3) && CSCDxyTTSeg#3>0.) || ((CSCDxyTTSeg#4<5. || CSCDxyTTSeg#4<5*CSCDxyErrTTSeg#4) && CSCDxyTTSeg#4>0.) ) "#for segment efficiency, without closest to LCT requirement
DenominatorRequire_ExtraStation2="( ( (CSCDxyTTSeg#1<5. || CSCDxyTTSeg#1<5*CSCDxyErrTTSeg#1) && CSCDxyTTSeg#1>0.) || ((CSCDxyTTSeg#3<5. || CSCDxyTTSeg#3<5*CSCDxyErrTTSeg#3) && CSCDxyTTSeg#3>0.) || ((CSCDxyTTSeg#4<5. || CSCDxyTTSeg#4<5*CSCDxyErrTTSeg#4) && CSCDxyTTSeg#4>0.) ) "#for segment efficiency, without closest to LCT requirement
DenominatorRequire_ExtraStation3="( ( (CSCDxyTTSeg#1<5. || CSCDxyTTSeg#1<5*CSCDxyErrTTSeg#1) && CSCDxyTTSeg#1>0.) || ((CSCDxyTTSeg#2<5. || CSCDxyTTSeg#2<5*CSCDxyErrTTSeg#2) && CSCDxyTTSeg#2>0.) || ((CSCDxyTTSeg#4<5. || CSCDxyTTSeg#4<5*CSCDxyErrTTSeg#4) && CSCDxyTTSeg#4>0.) ) "#for segment efficiency, without closest to LCT requirement
DenominatorRequire_ExtraStation4="( ( (CSCDxyTTSeg#1<5. || CSCDxyTTSeg#1<5*CSCDxyErrTTSeg#1) && CSCDxyTTSeg#1>0.) || ((CSCDxyTTSeg#2<5. || CSCDxyTTSeg#2<5*CSCDxyErrTTSeg#2) && CSCDxyTTSeg#2>0.) || ((CSCDxyTTSeg#3<5. || CSCDxyTTSeg#3<5*CSCDxyErrTTSeg#3) && CSCDxyTTSeg#3>0.) ) "#for segment efficiency, without closest to LCT requirement
...
print 'apply cut: ',MuTrackPairCut
