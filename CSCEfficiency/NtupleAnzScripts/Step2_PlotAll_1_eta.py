...
Prefix="/afs/hep.wisc.edu/cms/senka/CMSSW_7_4_7/src/CSCEfficiency/CSCEfficiency/NtupleAnzScripts/2015C_LCT_newAlign_withHLTIsoTkMu_matchOtherStationsORME13_eta/"
Postfix=""
Group="Stationseta"
...
print " ->TagAndProbeFitResult: ",TagProbeFitResult
ResultPlotsFileName="resultplots_NtupleAnzScripts_2015C_LCT_eta.root"
...
if "Stations" in Group:
  ...
  #split tree to chamber
    ...
    file_out.cd()
    SegCanvas.Write()
    SegCanvas.SaveAs("SegCanvas_2D_Run2015B_newAlign_stations.pdf")
    SegCanvas.SaveAs("SegCanvas_2D_Run2015B_newAlign_stations.root")
    SegCanvas.SaveAs("SegCanvas_2D_Run2015B_newAlign_stations.C")
    LCTCanvas.Write()
    LCTCanvas.SaveAs("LCTCanvas_2D_Run2015B_newAlign_stations_phi.pdf")
    LCTCanvas.SaveAs("LCTCanvas_2D_Run2015B_newAlign_stations_phi.root")
    LCTCanvas.SaveAs("LCTCanvas_2D_Run2015B_newAlign_stations_phi.C")
    SEGEff.Write()
    SEGEff_upErr.Write()
