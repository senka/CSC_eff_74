...
TagProbeFitResult="2015C_LCT_newAlign_withHLTIsoTkMu_matchOtherStationsORME13/TnP_"+dir_+"_"
Group="Chambers"
...
cms_label.AddText("CMS Preliminary                                                  #sqrt{s}=13 TeV,  L=46 pb^{-1}")
...
#    SegCanvas.SaveAs("SegCanvas_2D_Run2015C_HLTIsoTkMu_fixedGanging_matchingORME13.C")
    LCTCanvas.Write()
    LCTCanvas.SaveAs("LCTCanvas_2D_Run2015C_HLTIsoTkMu_fixedGanging_matchingORME13.pdf")
    LCTCanvas.SaveAs("LCTCanvas_2D_Run2015C_HLTIsoTkMu_fixedGanging_matchingORME13.root")
    LCTCanvas.SaveAs("LCTCanvas_2D_Run2015C_HLTIsoTkMu_fixedGanging_matchingORME13.C")
    SEGEff.Write()
    SEGEff_upErr.Write()
